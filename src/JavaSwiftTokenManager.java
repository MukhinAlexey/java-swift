...
private static final int jjStopStringLiteralDfa_0(int pos, long active0, long active1, long active2){
   switch (pos)
   {
      case 0:
         ...
         if ((active0 & 0xc000000L) != 0L || (active2 & 0x600f180000000L) != 0L)
         {
            jjmatchedKind = 44;
            return -1;
         }
         ...
         do
         {
            switch(jjstateSet[--i])
            {
               ...
               case 9:
                  ...
                  break;
               case 13:
                  if ((0xf000ac6200000000L & l) != 0L && kind > 44)
                     kind = 44;
                  break;
               case 14:
         ...
         do
         {
            switch(jjstateSet[--i])
            {
               ...
               case 12:
                  ...
                  break;
               case 13:
                  if ((0x5000000040000000L & l) != 0L && kind > 44)
                     kind = 44;
                  break;
               case 19:
                  if (curChar == 92)
         ...
         do
         {
            switch(jjstateSet[--i])
            {
               ...
               case 17:
                  ...
                  break;
               case 18:
                  if (jjCanMove_6(hiByte, i1, i2, l1, l2) && kind > 45)
                     kind = 45;
                  break;
...
static final long[] jjtoToken = {
   0xffffffffffffffc1L, 0xffffffffffffffffL, 0x7ffffffffffffL, 
};
